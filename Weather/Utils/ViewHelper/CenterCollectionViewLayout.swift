...
public extension UICollectionView {
    convenience init(frame: CGRect = .zero, centeredCollectionViewFlowLayout: CenterCollectionViewLayout) {
        self.init(frame: frame, collectionViewLayout: centeredCollectionViewFlowLayout)
        decelerationRate = UIScrollView.DecelerationRate.fast
    }
}

open class CenterCollectionViewLayout: UICollectionViewFlowLayout {
...
private extension CenterCollectionViewLayout {
